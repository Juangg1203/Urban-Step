...
<div class="d-flex flex-wrap gap-2">
                    ...
                    <c:if test="${usuarioActual.vendedor}">
                        <a href="${ctx}/panel/venta-asistida" class="btn btn-hilo btn-sm">Venta asistida</a>
                        <a href="${ctx}/panel/mis-comisiones" class="btn btn-contorno btn-sm">Mis comisiones</a>
                    </c:if>
