    ...
    <form method="post" action="${ctx}/checkout">
        ...
        <div class="row g-4">
            <div class="col-lg-7">
                ...
                <div class="ficha p-4 mb-3">
                    <h2 class="fs-5 mb-2"><spring:message code="checkout.vendedorTitulo" /></h2>
                    <p class="small text-muted"><spring:message code="checkout.vendedorTexto" /></p>
                    <select name="vendedorId" class="form-select">
                        <option value=""><spring:message code="checkout.vendedorNinguno" /></option>
                        <c:forEach var="v" items="${vendedores}">
                            <option value="${v.id}">${v.nombreUsuario}</option>
                        </c:forEach>
                    </select>
                </div>
