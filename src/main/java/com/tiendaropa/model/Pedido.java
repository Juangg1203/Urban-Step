...
public class Pedido {
    ...
    // --- comision de venta ---
    /**
     * Vendedor asociado al pedido, si lo hay. Se fija de dos formas, nunca
     * las dos a la vez: el cliente lo elige en el checkout, o el propio
     * vendedor arma el pedido por el (venta asistida). No se reasigna
     * despues desde la interfaz, para no manipular comisiones ya generadas.
     */
    @ManyToOne
    ...
    private java.math.BigDecimal comisionMonto = java.math.BigDecimal.ZERO;

    @Enumerated(EnumType.STRING)
    @Column(name = "comision_estado", length = 20)
    private EstadoComision comisionEstado = EstadoComision.NO_APLICA;
    ...
    public java.math.BigDecimal getComisionMonto() { return comisionMonto; }
    public void setComisionMonto(java.math.BigDecimal comisionMonto) { this.comisionMonto = comisionMonto; }
    public EstadoComision getComisionEstado() { return comisionEstado; }
    public void setComisionEstado(EstadoComision comisionEstado) { this.comisionEstado = comisionEstado; }
    public boolean isTieneVendedor() { return vendedor != null; }
